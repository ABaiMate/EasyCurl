...
const els = {
  ...
  clearRequestBtn: document.querySelector("#clearRequestBtn"),
...
function bindActions() {
  ...
  els.clearRequestBtn.addEventListener("click", clearCurrentRequest);
...
function clearCurrentRequest() {
  ...
  setStatus("Cleared current request. Paste curl or enter a new URL to start over.", "ok");
}
...
function resetResponse() {
  els.responseStatus.textContent = "Idle";
  els.responseStatus.className = "status-pill";
  els.responseTime.textContent = "0 ms";
  els.responseBody.textContent = "No response yet.";
  els.responseHeaders.textContent = "";
